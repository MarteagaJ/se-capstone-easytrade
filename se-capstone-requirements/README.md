...
Your demo application should contain a Web frontend where user sessions and activity can be tracked and correlated to the backend services. Demonstrate how you can capture core vitals, frontend error tracking, and end-to-end visibility - and tie these Frontends to their back-end Services.
  - [Documentation](https://www.dynatrace.com/hub/detail/experience-vitals/)
  - [Video](https://www.youtube.com/watch?v=LoCtYsxuYoU)  
    
**6. Dashboards**
Demonstrate the use of Dashboards within your Environment to show the health of your environment, both from an Application and Infrastructure perspective. 
  - [Documentation](https://docs.dynatrace.com/docs/shortlink/dashboards)
  - [Video](https://www.youtube.com/watch?v=K8rcj7fK9NM)  

**7. AI-driven analysis**

Demonstrate AI-driven insights using [Dynatrace Intelligence](https://docs.dynatrace.com/docs/dynatrace-intelligence).
It is recommended to have your demo Application experience a failure, crash, errors so that Dynatrace's Anomaly Detection will automatically detect this behavior and generate a Problem.
    - Use the [Problems App](https://www.youtube.com/watch?v=Tud2K3zyync&list=PLqt2rd0eew1aHqfD-XRNVaIAiN-QxkPK6&index=6) for analyzing detected problems within your environment. 

**8. Notebooks and DQL**

Build at least one [Notebook](https://docs.dynatrace.com/docs/analyze-explore-automate/dashboards-and-notebooks/notebooks) that includes at least one [DQL](https://docs.dynatrace.com/docs/platform/grail/dynatrace-query-language) query you wrote - or that [Dynatrace Assist](https://docs.dynatrace.com/docs/dynatrace-intelligence/agentic-and-generative-ai/chat-with-dynatrace-assist) generated.
